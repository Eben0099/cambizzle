...
const Terms = () => {
  ...
  const termsSections = sections?.terms || [];
                  ...
                  <AccordionContent className="pt-2">
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                      ...
                      <ul className="space-y-2 text-gray-600 ml-6">
                        ...
                        <li className="flex gap-3">
                          <span className="text-[#D6BA69]">•</span>
                          <span>{t('terms.emailLabel')}: <a href={`mailto:${contact?.supportEmail || 'info@cambizzle.com'}`} className="text-[#D6BA69] hover:underline">{contact?.supportEmail || 'info@cambizzle.com'}</a></span>
                        </li>
                        <li className="flex gap-3">
                          <span className="text-[#D6BA69]">•</span>
                          <span>{t('terms.phoneLabel')}: {contact?.supportPhone || '+237678185437'}</span>
                        </li>
                      </ul>
                    </div>
                  </AccordionContent>
