    ...
    return (
      <div className="bg-white rounded-xl shadow-sm">
        <div className="p-6 sm:p-12 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">{t('profileFavorites.noFavorites')}</h3>
          <p className="text-sm sm:text-base text-gray-500">{t('profileFavorites.noFavoritesYet')}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg sm:text-xl font-semibold text-gray-900">
        {t('profileFavorites.myFavorites')} ({favorites.length})
      </h3>
